...
request_7 = Request.create!(name: "blunt object", details: "not for hitting", item_category: "tools", borrow_date: '2022-01-19', return_date: '2022-01-23', requested_by_id: user_7.id, lender_id: user_6.id, community_id: 2)

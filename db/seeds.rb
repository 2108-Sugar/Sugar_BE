...
request_10 = Request.create!(name: "sledge hammer", details: "Building a fence", item_category: "tools", status: 2, borrow_date: '2022-02-02', return_date: '2022-02-04', requested_by_id: user_2.id, lender_id: user_3.id, community_id: 1)
...
request_12 = Request.create!(name: "shovel", details: "garden work", item_category: "tools", status: 2, borrow_date: '2022-02-06', return_date: '2022-02-07', requested_by_id: user_3.id, lender_id: user_4.id, community_id: 1)
